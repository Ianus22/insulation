            ...
            <div className='flex flex-col md:flex-row justify-between items-center mt-6'>
              <div className='flex flex-col items-start'>
                <div className='flex items-center mb-4'>
                  <svg data-testid='geist-icon' height='16' stroke-linejoin='round' viewBox='0 0 16 16' width='12'>
                    <path
                      fill-rule='evenodd'
                      clip-rule='evenodd'
                  ...
                  <span className='ml-2'>Knöllgasse 23, Wien</span>
                </div>
                <div className='flex items-center mb-4'>
                  ...
                  <span className='ml-2'>+359 58 331 24</span>
                </div>
                <Map />
              </div>
              <ContactForm />
