          ...
          <div className="flex items-center justify-between p-4 w-full">
            <Link href="/">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h1 className="text-xl md:text-3xl text-slate-950 font-bold">
                    SmartInsulation
                  </h1>
                </div>
              </div>
            ...
            <div className="hidden md:flex justify-end space-x-4 ml-8">
              ...
              <NavigationMenuItem>
                <Link href="/toolsused" legacyBehavior passHref>
                  <NavigationMenuLink
                    className={`${navigationMenuTriggerStyle()} text-xl`}
                  >
                    Tools used
              ...
              <div className="flex flex-col space-y-2 p-4">
                ...
                <Link href="/tool">
                  <NavigationMenuItem>
                    <Button
                      variant="outline"
                      className="bg-[#C5ECE0] hover:bg-green-200 text-lg py-2 px-4 square-lg"
                    >
                      Try out!
                    </Button>
                  </NavigationMenuItem>
